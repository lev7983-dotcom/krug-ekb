...
function clearKrugImportContext(){
  krugActiveImportId=0;krugImportLoaded=0;
  const cleanUrl=new URL(location.href);cleanUrl.searchParams.delete('import');history.replaceState(null,'',cleanUrl);
}
